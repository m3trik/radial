...
delete these after sync: **************************************************************************************

# Traceback (most recent call last):
#   File "O:/Cloud/Code/_scripts/radial/radial\apps\maya\slots\maya_transform.py", line 132, in chk014
#     state = 1 if self.transform_submenu.chk014.isChecked() else 0
# AttributeError: 'Transform' object has no attribute 'transform_submenu'
fix: self.transform_submenu_ui
...
#   File "C:\Program Files\Autodesk\Maya2022\Python37\lib\site-packages\pymel\core\animation.py", line 751, in parentConstraint
#     res = _parentConstraint(*args, **kwargs)
#   File "C:\Program Files\Autodesk\Maya2022\Python37\lib\site-packages\pymel\core\animation.py", line 111, in constraintWithWeightSyntax
...
#   File "O:/Cloud/Code/_scripts/radial/radial\slots.py", line 311, in getAxisFromCheckBoxes
#     ui = self.currentUi
