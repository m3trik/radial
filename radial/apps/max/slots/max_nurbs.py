...
class Nurbs(Init):
	...
	def draggable_header(self, state=None):
		...
		if state is 'setMenu':
			draggable_header.contextMenu.add(wgts.ComboBox, setObjectName='cmb000', setToolTip='Maya Curve Operations')
			return
	...
	def tb000(self, state=None):
		...
		if state is 'setMenu':
			...
			tb.menu_.add('QSpinBox', setText='Start Sweep', setObjectName='s003', setValue=3, setMinMax_='0-360 step1', setToolTip='	The value for the start sweep angle.')
			tb.menu_.add('QSpinBox', setText='End Sweep', setObjectName='s004', setValue=3, setMinMax_='0-360 step1', setToolTip='The value for the end sweep angle.')
			...
			tb.menu_.add('QDoubleSpinBox', setText='Tolerance', setObjectName='s006', setValue=0.001, setMinMax_='0-9999 step.001', setToolTip='Tolerance to build to (if useTolerance attribute is set).')
			return
	...
	def tb001(self, state=None):
		...
		if state is 'setMenu':
			...
			tb.menu_.add('QSpinBox', setText='Angle Loft: Spans', setObjectName='s007', setValue=6, setMinMax_='2-9999 step1', setToolTip='Angle loft: Number of duplicated points (spans).')
			return
